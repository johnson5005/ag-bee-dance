...
# install.packages(c("circular", "rjags", "sp", "rgdal", "raster", "png", "googlesheets4", "magrittr", "oce", "googlesheets4"))
...
setwd("./2019\ ENTMLGY2200") # Sponsler: path to the working directory within the Git repository
...
googleSheetsKey <- "1kUu7DLIM1LaOsXZAV3K6hwke2TilBNdlBG5lYIMpd84" #https://docs.google.com/spreadsheets/d/1kUu7DLIM1LaOsXZAV3K6hwke2TilBNdlBG5lYIMpd84/edit#gid=0
dance_ss <- gs4_get(googleSheetsKey)
...
hiveEasting <- 427889.52 # Sponsler: the UTM 17N (EPSG:26917) easting of the hives in meters
#hiveEasting <- 430263.51 # Soybean 2019 # Sponsler: the UTM 17N (EPSG:26917) easting of the hives in meters
#hiveNorthing <- 108900				# the UK grid northing of the hives in meters
hiveNorthing <- 4513405.35 # Sponsler: the UTM 17N (EPSG:26917) northing of the hives in meters
#hiveNorthing <- 4513732.97 # Soybean 2019 # Sponsler: the UTM 17N (EPSG:26917) northing of the hives in meters
...
writeRaster(new.data.rast, filename = "data/2019_soybean_dance_ENTMLGY2200.tif", format = "GTiff", overwrite = T) # Sponsler: this geotiff can be loaded in QGIS to overlay on landscape layer

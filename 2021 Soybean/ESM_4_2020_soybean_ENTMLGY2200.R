...
setwd("./2019\ Soybean") # Sponsler: path to the working directory within the Git repository
...
# Real data  "1Jk4eCDEfjXjj6p0eyA2b6Rh72omFnobzc4-Ala2tuLA", # https://docs.google.com/spreadsheets/d/1Jk4eCDEfjXjj6p0eyA2b6Rh72omFnobzc4-Ala2tuLA/edit?usp=sharing
  "1kUu7DLIM1LaOsXZAV3K6hwke2TilBNdlBG5lYIMpd84", # https://docs.google.com/spreadsheets/d/1kUu7DLIM1LaOsXZAV3K6hwke2TilBNdlBG5lYIMpd84/edit#gid=0 Class data
  sheet = "Data", 
  col_names=TRUE 

...
setwd("./2020\ Soybean") # Sponsler: path to the working directory within the Git repository
...
waggleData <- read_sheet(
  "1Odle9eu3LA9gWxp9sZwz5mxPjgwNOU7-9l3xpjVbr3w", # https://docs.google.com/spreadsheets/d/1Odle9eu3LA9gWxp9sZwz5mxPjgwNOU7-9l3xpjVbr3w/edit#gid=0
  sheet = "Data", 
  col_names=TRUE, 

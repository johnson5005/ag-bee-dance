...
setwd("./2022\ Wooster") # Sponsler: path to the working directory within the Git repository
...
waggleData <- read_sheet(
  "1rK3u-pHnmM_llluAeTHb4QmSM2bOAjpiy6PPKJZ_x0A", # https://docs.google.com/spreadsheets/d/1rK3u-pHnmM_llluAeTHb4QmSM2bOAjpiy6PPKJZ_x0A/edit#gid=0
  sheet = "Data", 
  col_names=TRUE, 
